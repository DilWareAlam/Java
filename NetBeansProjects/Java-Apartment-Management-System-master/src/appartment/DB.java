...
{
     Connection con;
     String serv[]={"Electricity","Gas","T&T","Water","Other"};
    DB()
    {
     try
        {
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/appartment?zeroDateTimeBehavior=convertToNull","root","");
 ...
 void connect()
 {
    ...
    String calcBill(String flat) 
    {
      ...
      else
      {
        ...
        //="Name: "+o1.getString("name")+"<br/>"+"Flat No.: "+o1.getString("flatno")+"<br/>"+"Contact No: "+o1.getNString("phone");
         ...
         while(o1.next())
      {
         text+=fullservConv(o1.getString("serv"))+"  Taka: "+o1.getString("price")+"/-<br/>" ;
         cost+=Double.parseDouble(o1.getString("price"));
      }
         text+="<hr/> Total: Taka: "+cost+"/- <br/> <br/> For any queries, please contact admin";
         text+="</html>";
      }
        }
        catch(Exception e)
      ...
      String genrateList()
    {
        ...
        {
             text="<html>";
             text+="<table border='1' text-align='center' style='width:100%'> <tr> <th>Flat No.</th><th>Amount to paid (Taka)</th> </tr>";
